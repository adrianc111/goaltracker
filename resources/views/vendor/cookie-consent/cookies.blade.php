                    ...
                    <div class="cookies__section">
                        <label for="cookies-policy-check-{{ $category->key() }}" class="cookies__category">
                            @if ($category->key() === 'essentials')
                                ...
                                <input style="background: black;" type="checkbox" name="categories[]" value="{{ $category->key() }}" id="cookies-policy-check-{{ $category->key() }}" checked="checked" disabled="disabled" />
                            @else
                                <input style="background: black;" type="checkbox" name="categories[]" value="{{ $category->key() }}" id="cookies-policy-check-{{ $category->key() }}" />
                            @endif
                        ...
                        <a href="#cookies-policy-{{ $category->key() }}" class="cookies__details underline" style="color: black;">@lang('cookieConsent::cookies.details.more')</a>
                    </div>
                    @endforeach
                </div>
                <div class="cookies__save">
                    <button type="submit" class="cookiesBtn__link" style="background: black;border:none;">@lang('cookieConsent::cookies.save')</button>
                </div>
            </form>
        </div>
    </div>
